...
function openUrl(url){
	window.open("http://129.213.108.141:8080/cache/ts.csv");
}
function offers() {
...
function customUI() {
	...
	footerElement.insertAdjacentHTML("afterend","<b>Suggestions:<b><div id='suggestion-container'><div id='suggestion-box'><left><p id='spara'></p><a class='suggestion-style' href='javascript:window.parent.order();'>Fetch Requisition Details</a><a class='suggestion-style' href='javascript:window.parent.offers();'>Instance URLs</a><a class='suggestion-style' href='javascript:window.parent.reportIssue();'>Procurement Process Document</a></div></div>");
