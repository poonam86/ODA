...
({
    ...
    217: function (e, t, n) {
        ...
        function r(e) {
            var t = ["screen"];
            return e.minHeight && t.push("(min-height: " + e.minHeight + "px)"),
    ...
    320: function (e, t, n) {
        ...
        function r() {
            if (!document.getElementById(p.IFRAME_ID)) {
                g = void 0,
                v = void 0,
                window.__onWebMessengerFrameReady__ = s;
                for (var e = E[0], t = 0; t < E.length; e = E[++t])
                    m[e] && delete m[e];
                c(m, A)
            }
        }
        function o() {
            ...
            e.rel = "stylesheet",
            e.type = "text/css",
            e.href = "/bots-client-sdk-js/bots.1.16.5.css",
        ...
        function s(e) {
            ...
            g = e,
            y || f.init(v);
            for (var t = E[0], n = 0; n < E.length; t = E[++n])
                m[t] = g[t];
            if (w) {
            ...
            if (x) {
                var a,
                c = (a = g).init.apply(a, i(x));
                x = void 0;
                for (var u = _[0], d = 0; d < _.length; u = _[++d])
                    c = "then" === u.type ? c.then(u.next) : c.catch(u.next);
                _ = []
            }
        }
        function a() {
        ...
        A = {
            ...
            init: function () {
                for (var e = arguments.length, t = Array(e), n = 0; n < e; n++)
                    t[n] = arguments[n];
                x = t,
                y = t.length > 0 && !!t[0].embedded,
                M || W || (0, l.waitForPage)(function () {
                    o(),
                    a()
                });
                var i = {
